package com.example.who_s_ohw.ui.feature.setting
...
@Composable
fun HeaderSetting(navController: NavController, onImageClick: () -> Unit) {
    Box(
        modifier = Modifier
            .fillMaxWidth()
            .height(150.dp)
...
fun SettingItem(
    ...
    Column(modifier = Modifier
        ...
        Divider(color = Color(0x374C662B), thickness = 1.dp)
    }
}
